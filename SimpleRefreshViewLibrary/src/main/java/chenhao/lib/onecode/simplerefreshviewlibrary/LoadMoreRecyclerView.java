...
public class LoadMoreRecyclerView extends RecyclerView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            noMoreTxt=typedArray.getString(R.styleable.SimpleRefreshViewLibrary_lmfv_txt_noMore);
            noMoreTxtColor=typedArray.getColor(R.styleable.SimpleRefreshViewLibrary_lmfv_txtColor_noMore,noMoreTxtColor);
        } finally {
            if (typedArray != null) {
                typedArray.recycle();
            }
