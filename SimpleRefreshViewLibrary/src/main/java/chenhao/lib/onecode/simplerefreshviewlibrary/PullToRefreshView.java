package chenhao.lib.onecode.simplerefreshviewlibrary;
...
import chenhao.lib.onecode.simplerefreshviewlibrary.avloading.AVLoadingIndicatorView;
...
public class PullToRefreshView extends ViewGroup {
    ...
    public PullToRefreshView(Context context, AttributeSet attrs) {
        ...
        try {
            typedArray = context.obtainStyledAttributes(attrs, R.styleable.SimpleRefreshViewLibrary);
            icon_refresh_down=typedArray.getResourceId(R.styleable.SimpleRefreshViewLibrary_ptrv_icon_down,R.drawable.onecode_refresh_down_b);
            icon_refresh_up=typedArray.getResourceId(R.styleable.SimpleRefreshViewLibrary_ptrv_icon_up,R.drawable.onecode_refresh_up_b);
            loadColor=typedArray.getColor(R.styleable.SimpleRefreshViewLibrary_avlv_color,loadColor);
            loadStyle=typedArray.getColor(R.styleable.SimpleRefreshViewLibrary_avlv_style,loadStyle);
        } finally {
            if (typedArray != null) {
                typedArray.recycle();
            }
