package chenhao.lib.onecode.simplerefreshviewlibrary.avloading;
...
import chenhao.lib.onecode.simplerefreshviewlibrary.R;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SimpleRefreshViewLibrary);
        mIndicatorId=a.getInt(R.styleable.SimpleRefreshViewLibrary_avlv_style, BallPulse);
        mIndicatorColor=a.getColor(R.styleable.SimpleRefreshViewLibrary_avlv_color, Color.WHITE);
        a.recycle();
        mPaint=new Paint();
